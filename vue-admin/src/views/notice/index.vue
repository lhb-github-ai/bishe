  ...
  <div>
    ...
    <el-form :inline="true" class="user-search">
      <el-form-item label="搜索：">
        <el-input size="small" v-model="noticeQuery.noticeTitle" placeholder="输入公告标题"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column
       align="center"
        label="公告标题"
        prop="noticeTitle"
        v-model="notices.noticeTitle">
      </el-table-column>
      <el-table-column
       align="center"
        label="公告内容"
        prop="notice"
        v-model="notices.notice">
      </el-table-column>
      <el-table-column
       align="center"
        label="管理员姓名"
  ...
  export default {
    ...
    methods: {
      ...
      getListByPage(page=1){
        notice.listByPage(this.page,this.limit,this.noticeQuery).then(res=>{
      ...
      handleDelete(id){
         ...
         this.$confirm('此操作将永久删除题库记录, 是否继续?', '提示', {
            ...
            type: 'warning'
              ...
              notice.remove(id).then(response=>{
                this.getListByPage()
             }).catch(error=>{
              // console.log(error);
            })
