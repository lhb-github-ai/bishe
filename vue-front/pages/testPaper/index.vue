      ...
      <div class="main">
        <div class="bread" style="padding-bottom:10px">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item style=" font-size:17px;">测试中心</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
        <el-table 
          :data="papers"
          ...
          <el-table-column align="center"  width="340px"
           ...
           <el-table-column 
            align="center" width="180" >
              ...
              <template slot-scope="scope" >
                 <span  v-if="scope.row.tip==='测试时间已结束'" style="color:#F56C6C;font-size:17px;font-weight:600">{{scope.row.tip}}</span>
                 <span  v-if="scope.row.tip==='测试时间还未开始'" style="color:#909399;font-size:17px;font-weight:600">{{scope.row.tip}}</span>
                 <span  v-if="scope.row.tip==='测试时间还未结束'" style="color:#67C23A;font-size:17px;font-weight:600">{{scope.row.tip}}</span>
            </template>
          </el-table-column>
          <el-table-column
   ...
   // components: {Foot, Topnav},
    ...
    methods:{
      ...
      getListByPage(page=1){
        paper.getPaperList(this.page,this.limit,this.loginInfo.id,false).then(res=>{
