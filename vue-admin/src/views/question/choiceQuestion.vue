  ...
  <div>
    ...
    <el-table
      ...
      <el-table-column 
        ...
        <template slot-scope="scope">
          <router-link :to="'/question/editChoiceQuestion/'+scope.row.id">
          <el-button
            size="small"
            type="primary"
          >修改
  ...
  export default {
    ...
    methods: {
       handleDelete(id){
         ...
         this.$confirm('此操作将永久删除题库记录, 是否继续?', '提示', {
            ...
            type: 'warning'
              ...
              choiceQuestion.deleteQuestion(id).then(response=>{
                this.getListByPage()
             }).catch(error=>{
              // console.log(error);
            })
      ...
      getListByPage(page=1){
        choiceQuestion.getListByPage(this.page,this.limit,this.choiceQuestionQuery).then(res=>{
