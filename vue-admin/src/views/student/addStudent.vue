...
<el-row :gutter="20">
 ...
 <el-col :span="10">
 <el-form :model="student" label-width="100px" class="demo-ruleForm">
    <el-form-item label="学号"  class="aaa">
      <el-input v-model="student.studentId" class="option-input" placeholder="请输入选项学号"></el-input>
    </el-form-item>
    <el-form-item label="学生姓名" class="aaa">
      <el-input v-model="student.studentName" class="option-input" placeholder="请输入选项学生姓名"></el-input>
    </el-form-item>
    ...
    <el-form-item label="年龄" class="aaa">
      <el-input v-model="student.age" class="option-input" placeholder="请输入选项年龄"></el-input>
    </el-form-item>
    <el-form-item label="所属班级"  class="aaa">
      <el-input v-model="student.clazz"  class="option-input" placeholder="请输入所属班级"></el-input>
    </el-form-item>
     <el-form-item label="所属学院"  class="aaa">
      <el-input v-model="student.institute"  class="option-input" placeholder="请输入所属学院"></el-input>
    </el-form-item>
     <el-form-item label="电话号码"  class="aaa">
      <el-input v-model="student.tel"  class="option-input" placeholder="请输入电话号码"></el-input>
    </el-form-item>
    <el-form-item label="邮箱"  class="aaa">
      <el-input v-model="student.email"  class="option-input" placeholder="请输入邮箱"></el-input>
    </el-form-item>
         ...
         this.student.avatar= this.imageUrl 
          ...
          console.log(res);
              if (res.data.repeat==='repeat'){
                ...
                this.$alert('修改成功,点击跳转到学生信息列表', '消息', {
                  confirmButtonText: '确定',
                  callback: action => {
